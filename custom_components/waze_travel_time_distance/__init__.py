"""The waze_travel_time_distance component."""
...
async def async_setup_entry(hass: HomeAssistant, config_entry: ConfigEntry) -> bool:
    ...
    async def async_get_travel_times_service(service: ServiceCall) -> ServiceResponse:
        ...
        response = await async_get_travel_times(
            ...
            distance_filter=service.data.get(
...
async def async_migrate_entry(hass: HomeAssistant, config_entry: ConfigEntry) -> bool:
    ...
    if config_entry.version == 1:
        ...
        # Migrate incl_filter from string to list
        ...
        # Migrate excl_filter from string to list
        ...
        # Ensure distance_filter exists
        if CONF_DISTANCE_FILTER not in options:
            options[CONF_DISTANCE_FILTER] = DEFAULT_DISTANCE_FILTER
