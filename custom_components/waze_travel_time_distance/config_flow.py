"""Config flow for Waze Travel Time Distance integration."""
...
OPTIONS_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_DISTANCE_FILTER): TextSelector(),
...
class WazeDistanceOptionsFlow(OptionsFlow):
    """Handle an options flow for Waze Travel Time Distance."""
    ...
    async def async_step_init(self, user_input=None) -> ConfigFlowResult:
        ...
        if user_input is not None:
            ...
            if user_input.get(CONF_DISTANCE_FILTER) is None:
                user_input[CONF_DISTANCE_FILTER] = DEFAULT_DISTANCE_FILTER
...
class WazeDistanceConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Waze Travel Time Distance."""
    ...
    def async_get_options_flow(
        ...
        return WazeDistanceOptionsFlow()
